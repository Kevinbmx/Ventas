...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ClientesConnectionString2 %>" SelectCommand="SELECT * FROM [tbl_cliente]"></asp:SqlDataSource>
