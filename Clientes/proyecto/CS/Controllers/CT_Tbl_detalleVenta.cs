...
namespace Controllers
{
	public class CT_Tbl_detalleVenta
	{
		...
		DA_Tbl_detalleVenta oDA_Tbl_detalleVenta = new DA_Tbl_detalleVenta();
		...
		{
			string resultado = oDA_Tbl_detalleVenta.Insert(tbl_detalleventa);
		...
		{
			return oDA_Tbl_detalleVenta.SelectAllByProducto_id(producto_id);
		}
		...
		{
			return oDA_Tbl_detalleVenta.SelectAllByVenta_id(venta_id);
		}
		...
		{
			return oDA_Tbl_detalleVenta.SelectAll();
		}
		...
		{
			return oDA_Tbl_detalleVenta.SelectAllList();
		}
...
/*
		...
		{
			string resultado = oDA_Tbl_detalleVenta.Delete();
			if (resultado.Contains("Error")) return resultado;
			else
			{
				return resultado;
