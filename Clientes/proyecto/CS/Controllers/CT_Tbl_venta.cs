...
namespace Controllers
{
	public class CT_Tbl_venta
	{
		...
		DA_Tbl_venta oDA_Tbl_venta = new DA_Tbl_venta();
		...
		{
			string resultado = oDA_Tbl_venta.Insert(tbl_venta);
		...
		{
			return oDA_Tbl_venta.Select(venta_id);
		}
		...
		{
			string resultado = oDA_Tbl_venta.Update(tbl_venta);
			if (resultado.Contains("Error")) return resultado;
			else
			{
				return resultado;
		...
		{
			return oDA_Tbl_venta.SelectAllByCliente_id(cliente_id);
		}
		...
		{
			string resultado = oDA_Tbl_venta.Delete(venta_id);
			if (resultado.Contains("Error")) return resultado;
			else
			{
				return resultado;
		...
		{
			return oDA_Tbl_venta.SelectAll();
		}
		...
		{
			return oDA_Tbl_venta.SelectAllList();
		}
