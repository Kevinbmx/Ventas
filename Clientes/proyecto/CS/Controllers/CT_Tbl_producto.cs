...
namespace Controllers
{
	public class CT_Tbl_producto
	{
		...
		DA_Tbl_producto oDA_Tbl_producto = new DA_Tbl_producto();
		...
		{
			string resultado = oDA_Tbl_producto.Insert(tbl_producto);
		...
		{
			return oDA_Tbl_producto.Select(producto_id);
		}
		...
		{
			string resultado = oDA_Tbl_producto.Update(tbl_producto);
			if (resultado.Contains("Error")) return resultado;
			else
			{
				return resultado;
		...
		{
			string resultado = oDA_Tbl_producto.Delete(producto_id);
			if (resultado.Contains("Error")) return resultado;
			else
			{
				return resultado;
		...
		{
			return oDA_Tbl_producto.SelectAll();
		}
		...
		{
			return oDA_Tbl_producto.SelectAllList();
		}
