...
namespace Controllers
{
	public class CT_Tbl_cliente
	{
		...
		DA_Tbl_cliente oDA_Tbl_cliente = new DA_Tbl_cliente();
		...
		{
			string resultado = oDA_Tbl_cliente.Insert(tbl_cliente);
		...
		{
			return oDA_Tbl_cliente.Select(cliente_id);
		}
		...
		{
			string resultado = oDA_Tbl_cliente.Update(tbl_cliente);
			if (resultado.Contains("Error")) return resultado;
			else
			{
				return resultado;
		...
		{
			string resultado = oDA_Tbl_cliente.Delete(cliente_id);
			if (resultado.Contains("Error")) return resultado;
			else
			{
				return resultado;
		...
		{
			return oDA_Tbl_cliente.SelectAll();
		}
		...
		{
			return oDA_Tbl_cliente.SelectAllList();
		}
