...
namespace DataAcces
{
	public class DA_Tbl_cliente
	{
		#region Variables

		protected DA_Conexion con = new DA_Conexion();
		...
		public virtual string Insert(EN_Tbl_cliente tbl_cliente)
		{
			...
			SqlParameter[] parameters = new SqlParameter[]
			{
				...
				new SqlParameter("@nit", (tbl_cliente.Nit==0)?Convert.DBNull:tbl_cliente.Nit)
			};
		...
		protected virtual EN_Tbl_cliente MakeEN_Tbl_cliente(SqlDataReader dataReader)
		{
			...
			oeN_Tbl_cliente.Nit =dataReader.IsDBNull(dataReader.GetOrdinal("nit"))? 0 : dataReader.GetInt32(dataReader.GetOrdinal("nit"));
